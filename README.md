...
* **Management & Strategy**: Project planning and management, multitasking, workflow automation, deadline management, and proactive problem-solving.
* **Interpersonal Skills**: Teamwork mindset, active listening, presentation skills, and high adaptability.

*Tools:*

|  |  |
| :--- | :--- |
| **Data & Analytics** | Python, SQL, Power BI, RedCap, MS Excel (Advanced) |
| **Medical Writing** | Veeva Vault, Zotero, Endnote, Mendeley, Grammarly, Paperpal |
| **AI & Automation** | Prompt Engineering, LLM-based research tools/chatbots, Git/Github |
| **Research Databases** | PubMed, Scopus, Web of Science, Embase, Google Scholar, Cochrane |
| **Design & Web** | BioRender, Canva, WordPress |
